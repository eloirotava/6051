...
/*
 * Tables from the South Silicon Valley / iComm vendor driver:
 * PHY and RF register settings, TX gain levels, PHY info table,
 * MAC RX decision table.
 *
 * Copyright (c) 2015 South Silicon Valley Microelectronics Inc.
 * Copyright (c) 2015 iComm Corporation
 */
#ifndef SSV6051_TABLES_H
#define SSV6051_TABLES_H
...
static struct ssv_reg phy_setting[] = {
...
static struct ssv_reg asic_rf_setting[] = {
...
#define PHY_INFO(_ctsdur, _ba, _ack, _llen_idx, _llen_en) \
	((_ctsdur) << 16 | (_ba) << 10 | (_ack) << 4 | (_llen_idx) << 1 | (_llen_en))
#define PHY_LLEN(_ba, _rts, _cts_ack) ((_ba) << 12 | (_rts) << 6 | (_cts_ack))
#define PHY_INFO_TBL1_SIZE	39
#define PHY_INFO_TBL2_SIZE	39
#define PHY_INFO_TBL3_SIZE	8

/* Per-rate PHY info: rate table, ACK/BA rates and durations, L-SIG lengths. */
static u32 phy_info_tbl[] = {
	...
	PHY_INFO(314, 0, 0, 0, 0), PHY_INFO(258, 0, 1, 0, 0),
	PHY_INFO(223, 0, 1, 0, 0), PHY_INFO(213, 0, 1, 0, 0),
	PHY_INFO(162, 0, 4, 0, 0), PHY_INFO(127, 0, 4, 0, 0),
	PHY_INFO(117, 0, 4, 0, 0), PHY_INFO(60, 7, 7, 0, 0),
	PHY_INFO(52, 7, 7, 0, 0), PHY_INFO(48, 9, 9, 0, 0),
	PHY_INFO(44, 9, 9, 0, 0), PHY_INFO(44, 11, 11, 0, 0),
	PHY_INFO(40, 11, 11, 0, 0), PHY_INFO(40, 11, 11, 0, 0),
	PHY_INFO(40, 11, 11, 0, 0), PHY_INFO(76, 7, 7, 0, 1),
	PHY_INFO(64, 9, 9, 1, 1), PHY_INFO(60, 9, 9, 2, 1),
	PHY_INFO(60, 11, 11, 3, 1), PHY_INFO(56, 11, 11, 4, 1),
	PHY_INFO(56, 11, 11, 5, 1), PHY_INFO(56, 11, 11, 5, 1),
	PHY_INFO(56, 11, 11, 5, 1), PHY_INFO(76, 7, 7, 6, 1),
	PHY_INFO(64, 9, 9, 1, 1), PHY_INFO(60, 9, 9, 2, 1),
	PHY_INFO(60, 11, 11, 3, 1), PHY_INFO(56, 11, 11, 4, 1),
	PHY_INFO(56, 11, 11, 5, 1), PHY_INFO(56, 11, 11, 5, 1),
	PHY_INFO(56, 11, 11, 5, 1), PHY_INFO(64, 7, 7, 0, 0),
	PHY_INFO(52, 9, 9, 0, 0), PHY_INFO(48, 9, 9, 0, 0),
	PHY_INFO(48, 11, 11, 0, 0), PHY_INFO(44, 11, 11, 0, 0),
	PHY_INFO(44, 11, 11, 0, 0), PHY_INFO(44, 11, 11, 0, 0),
	PHY_INFO(44, 11, 11, 0, 0),
	PHY_LLEN(50, 38, 35), PHY_LLEN(35, 29, 26), PHY_LLEN(29, 26, 23),
	PHY_LLEN(26, 23, 23), PHY_LLEN(23, 23, 20), PHY_LLEN(23, 20, 20),
	PHY_LLEN(47, 38, 35), PHY_LLEN(0, 0, 0),
};

/* Channels 1..14: synthesizer settings per crystal (26, 40, 24 MHz). */
struct ssv_chan_cal {
	u32 rf_ctrl_n;
	u32 rf_ctrl_f;
	u16 precision;
...
static const struct ssv_chan_cal chan_cal[3][14] = {
	{ {0xB9, 0x89D89E, 3859}, {0xB9, 0xEC4EC5, 3867}, {0xBA, 0x4EC4EC, 3875},
	  ...
	  {0xBB, 0xD89D8A, 3907}, {0xBC, 0x3B13B1, 3915}, {0xBC, 0x9D89D9, 3923},
	  {0xBD, 0x000000, 3931}, {0xBD, 0x627627, 3939}, {0xBD, 0xC4EC4F, 3947},
	  {0xBE, 0x276276, 3955}, {0xBF, 0x13B13B, 3974} },
	{ {0xf1, 0x333333, 3859}, {0xf1, 0xB33333, 3867}, {0xf2, 0x333333, 3875},
	  {0xf2, 0xB33333, 3883}, {0xf3, 0x333333, 3891}, {0xf3, 0xB33333, 3899},
	  {0xf4, 0x333333, 3907}, {0xf4, 0xB33333, 3915}, {0xf5, 0x333333, 3923},
	  {0xf5, 0xB33333, 3931}, {0xf6, 0x333333, 3939}, {0xf6, 0xB33333, 3947},
	  {0xf7, 0x333333, 3955}, {0xf8, 0x666666, 3974} },
	{ {0xC9, 0x000000, 3859}, {0xC9, 0x6AAAAB, 3867}, {0xC9, 0xD55555, 3875},
	  {0xCA, 0x400000, 3883}, {0xCA, 0xAAAAAB, 3891}, {0xCB, 0x155555, 3899},
	  {0xCB, 0x800000, 3907}, {0xCB, 0xEAAAAB, 3915}, {0xCC, 0x555555, 3923},
	  {0xCC, 0xC00000, 3931}, {0xCD, 0x2AAAAB, 3939}, {0xCD, 0x955555, 3947},
	  {0xCE, 0x000000, 3955}, {0xCF, 0x000000, 3974} },
};
